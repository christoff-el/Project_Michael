#ifndef LU_DECOMP_TRSV_MAT_TCC
#define LU_DECOMP_TRSV_MAT_TCC 1

template <typename IndexType, typename A, typename X>
void
trsv_mat(char uplo, char trans, char diag, char ordering, IndexType n,
